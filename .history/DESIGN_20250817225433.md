...
- **Homepage**: welcoming hero banner + quick access to amenities  
- **Booking Flow**: a simple 3-step process (choose site → confirm guidelines → checkout)  
- **Info Pages**: Rules, Rates, and Contact separated for clarity  

---
(lofi-home-wireframe.png "Lo-fi wireframe Homepage")
